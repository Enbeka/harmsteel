...
<body>
    ...
    <div class="form__container">
        ...
        <form method="post" class="form">
            ...
            <input type="text" class="form__input" placeholder="&#xf007   Imię i nazwisko" name="name" id="name"
                required>
            <input type="email" class="form__input" placeholder="&#xf0e0   Twój adres e-mail" name="email" id="email"
                required>
            <label for="message" class="form__label form__label--text">Treść wiadomości</label>
            <textarea name="area" class="form__input form__input--text" id="message" cols="25" rows="6"
                placeholder="&#xf5ad   Treść wiadomości" required></textarea>
